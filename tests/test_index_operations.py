...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_create_index(sdk_with_mock_session, mock_response):
    """Test index creation"""
    ...
    result = await sdk.create_index("test_index")
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_create_index_already_exists(sdk_with_mock_session, mock_response):
    ...
    result = await sdk.create_index("existing_index")
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_create_index_with_mapping(sdk_with_mock_session, mock_response):
    ...
    result = await sdk.create_index_with_mapping("test_index", mapping)
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_delete_index(sdk_with_mock_session, mock_response):
    """Test index deletion"""
    sdk = sdk_with_mock_session
    ...
    result = await sdk.delete_index("test_index")
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_get_index(sdk_with_mock_session, mock_response, sample_index_response):
    ...
    result = await sdk.get_index("test_index")
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_get_cat_indices(sdk_with_mock_session, mock_response):
    ...
    result = await sdk.get_cat_indices()
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_get_schema(sdk_with_mock_session, mock_response):
    ...
    result = await sdk.get_schema("test_index")
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_get_mappings(sdk_with_mock_session, mock_response):
    ...
    result = await sdk.get_mappings("test_index")
