...
@pytest.mark.unit
def test_upload_json_to_dataset_success(sdk_with_mock_session, mock_response, sample_bulk_response):
...
@pytest.mark.unit
def test_upload_json_to_dataset_auto_add_newline(sdk_with_mock_session, mock_response, sample_bulk_response):
