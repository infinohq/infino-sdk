...
async def main():
    ...
    async with InfinoSDK(access_key, secret_key, endpoint) as sdk:
        ...
        try:
            await sdk.create_role(role_name, role_config)
        ...
        try:
            await sdk.create_user(username, user_config)
        ...
        try:
            await sdk.create_role_mapping(mapping_name, mapping_config)
        ...
        try:
            ...
            await sdk.update_user(username, update_config)
        ...
        try:
            new_creds = await sdk.rotate_api_keys(username)
        ...
        try:
            account_info = await sdk.get_user_account_info()
